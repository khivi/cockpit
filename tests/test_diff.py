...
@pytest.mark.covers("**Do not** reimplement a git source in cockpit")
...
@pytest.mark.covers(
    "**Do not** add a `workspace=`/`keep_surface=` pair back for a second caller."
)
...
@pytest.mark.covers("**Do not** re-merge them into one call.")
