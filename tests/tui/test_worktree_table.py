...
@pytest.mark.asyncio
@pytest.mark.covers("table.links.escape-reaches-terminal~1")
...
@pytest.mark.covers("bands.snoozed.no-glyph-still-suppresses-bell~1")
...
@pytest.mark.covers("table.status-slot.pad-even-when-blank~1")
