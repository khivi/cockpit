...
@pytest.mark.covers("header.tick-glyphs.tooltip-spells-out-every-glyph~1")
...
@pytest.mark.covers("header.brand.url-as-argument~1")
...
@pytest.mark.asyncio
@pytest.mark.covers("header.bar.countdowns-anchored-right~1")
