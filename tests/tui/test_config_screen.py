...
@pytest.mark.covers("globalkeys.sync-vs-output-separation~1")
...
@pytest.mark.covers("palette.config-commands.discover-hit-required~1")
...
@pytest.mark.covers("palette.commands.order-is-the-menu~1")
