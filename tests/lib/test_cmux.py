...
@pytest.mark.covers("pills.pr-pill.exclusive-renderer")
...
@pytest.mark.covers("spawn.seed.no-raise-attempt-count")
...
@pytest.mark.covers("idle-gate.never-trust-needs-input")
...
@pytest.mark.covers("stacks.anchor.durable-anchor-required")
...
@pytest.mark.covers("idle-gate.verdict.single-function")
...
@pytest.mark.covers("idle-gate.reassert.no-second-authority")
...
@pytest.mark.covers("events.self-close.single-funnel")
@pytest.mark.covers("teardown.close.never-raw-cmux")
