...
@pytest.mark.covers("sidebar-tag.separator.last-char~1")
...
@pytest.mark.covers("sidebar-tag.token.resolved-string-only~1")
...
@pytest.mark.covers("spawn.adopt-grace.fails-open~1")
