...
@pytest.mark.covers("tickets.schema.no-legacy-alias~1")
...
@pytest.mark.covers("tickets.credentials.warning-no-ternary~1")
...
@pytest.mark.covers("capabilities.gate.warn-never-exit~1")
